...
![Редактирование запроса с помощью Scripting](images/image.png)
...
![Редактирование запроса с помощью Scripting](images/importing_script.png)

Базовый пример конфигурации в окне Script Editor:
-
